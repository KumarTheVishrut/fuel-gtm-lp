...
export function LogosSection() {
  return (
    <section className="relative space-y-5 border-t border-white/10 pt-8 pb-12">
      <p className="text-center font-mono text-xs tracking-[0.25em] uppercase" style={{ color: "#888888" }}>
        Trusted By
      </p>
...
const logos = [
  {
    svg: (
      <svg width="48" height="48" viewBox="0 0 66 68" fill="none" xmlns="http://www.w3.org/2000/svg">
